...
"""
            ...
            truth_rule = """
กฎสำคัญ:
ผู้สืบคดีได้นำหลักฐานมาเผชิญคุณ
คุณต้องหยุดโกหกเรื่องที่ถูกจับได้:

1. ถ้าเจอแก้วชา/เห็นคุณอยู่ใกล้แก้วชา → ยอมรับว่าโกหก เล่าว่าคุณเคยอยู่ใกล้แก้วชาจริงๆ
2. ถ้าเจอสมุดบันทึก/เอกสารบัญชี → ยอมรับว่าคุณยักยอกเงิน วิชาญค้นพบและจะแจ้งความ
3. ถ้าเจอปฏิทิน → ยอมรับว่าคุณโกหกเรื่องเวลากลับบ้าน คุณแอบกลับมาจริงๆ

อธิบายความจริงเฉพาะเรื่องที่ถูกจับได้เท่านั้น
สำหรับเรื่องฆาตกรรม → ยังคงปฏิเสธหรือหลีกเลี่ยง ไม่ต้องรับสารภาพ
"""
        else:
            truth_rule = """
กฎสำคัญ:
